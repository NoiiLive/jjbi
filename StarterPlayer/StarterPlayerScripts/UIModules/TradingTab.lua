...
function TradingTab.Init(parentFrame, tooltipMgr, focusFunc)
	...
	btnActive.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Active") end)
	btnSlot1.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Slot1") end)
	btnSlot2.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Slot2") end)
	btnSlot3.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Slot3") end)
	btnSlot4.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Slot4") end)
	btnSlot5.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "Slot5") end)
	btnSlotVIP.MouseButton1Click:Connect(function() SFXManager.Play("Click"); claimModal.Visible = false; Network.TradeAction:FireServer("ClaimStand", "SlotVIP") end)

	btnStyleActive.MouseButton1Click:Connect(function() SFXManager.Play("Click"); styleClaimModal.Visible = false; Network.TradeAction:FireServer("ClaimStyle", "Active") end)
	btnStyleSlot1.MouseButton1Click:Connect(function() SFXManager.Play("Click"); styleClaimModal.Visible = false; Network.TradeAction:FireServer("ClaimStyle", "Slot1") end)
	btnStyleSlot2.MouseButton1Click:Connect(function() SFXManager.Play("Click"); styleClaimModal.Visible = false; Network.TradeAction:FireServer("ClaimStyle", "Slot2") end)
	btnStyleSlot3.MouseButton1Click:Connect(function() SFXManager.Play("Click"); styleClaimModal.Visible = false; Network.TradeAction:FireServer("ClaimStyle", "Slot3") end)
	btnStyleSlotVIP.MouseButton1Click:Connect(function() SFXManager.Play("Click"); styleClaimModal.Visible = false; Network.TradeAction:FireServer("ClaimStyle", "SlotVIP") end)
