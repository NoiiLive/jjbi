...
SkillData.Skills = {
	...
	["Ball Breaker"] = { Requirement = "Golden Spin", Type = "Style", Mult = 2.8, StaminaCost = 12, EnergyCost = 0, Effect = "Debuff_Defense", Duration = 4, Cooldown = 5, Order = 7, VFX = "Punch", Description = "Manifests Ball Breaker to rapidly age the target, completely shredding their Defense." },
	...
	["Meltedin Palm"] = { Requirement = "Baoh Armed Phenomenon", Type = "Style", Mult = 2.4, StaminaCost = 8, EnergyCost = 0, Effect = "Acid", Duration = 2, Cooldown = 6, Order = 7, VFX = "Punch", Description = "Secretes corrosive enzymes from your palms, poisoning the enemy with Acid." },
	...
	["Rapier Thrust"] = { Requirement = "Soft Machine", Type = "Stand", Mult = 1.6, StaminaCost = 0, EnergyCost = 4, Order = 11, VFX = "Slash", Description = "A sharp stab with a rapier." },
	...
	["Shrink Slash"] = { Requirement = "Little Feet", Type = "Stand", Mult = 1.5, StaminaCost = 0, EnergyCost = 4, Order = 11, VFX = "Slash", Description = "A cutting strike that shrinks the impact zone." },
	...
	["Dual Wield Strike"] = { Requirement = "Anubis", Type = "Stand", Mult = 1.2, Hits = 2, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Slash", Description = "A rapid, cross-slashing attack." },
	...
	["Replay Strike"] = { Requirement = "Moody Blues", Type = "Stand", Mult = 1.8, StaminaCost = 0, EnergyCost = 5, Order = 11, VFX = "Punch", Description = "Replays a recorded punch with perfect accuracy." },
	...
	["WANNABE!"] = { Requirement = "Spice Girl", Type = "Stand", Mult = 0.6, Hits = 3, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "A fierce flurry of punches." },
	...
	["Internal Strike"] = { Requirement = "Diver Down", Type = "Stand", Mult = 1.8, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "Phases into the enemy to strike them from the inside." },
	...
	["Smack Sticker"] = { Requirement = "Kiss", Type = "Stand", Mult = 1.8, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "A heavy, sticker-empowered punch." },
	...
	["Silver Rapier"] = { Requirement = "Silver Chariot", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 5, Order = 11, VFX = "Slash", Description = "A blindingly fast sword thrust." },
	...
	["ARI ARI ARI!"] = { Requirement = "Sticky Fingers", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "A rapid barrage of zipper-laced punches." },
	...
	["Feral Strike"] = { Requirement = "Purple Haze", Type = "Stand", Mult = 1.8, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "A frenzied, incredibly violent punch." },
	...
	["String Beatdown"] = { Requirement = "Stone Free", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "Unravels its body to unleash a flurry of blows." },
	...
	["Dream Scythe"] = { Requirement = "Death 13", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Slash", Description = "A massive sweep with a grim reaper's scythe." },
	...
	["Water Slash"] = { Requirement = "Geb", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Slash", Description = "A high-pressure slash made of desert water." },
	...
	["Downward Dismemberment"] = { Requirement = "Green Day", Type = "Stand", Mult = 1.7, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Slash", Description = "A brutal physical attack targeting the lower body." },
	...
	["Iron Bar Strike"] = { Requirement = "Jail House Lock", Type = "Stand", Mult = 1.6, StaminaCost = 0, EnergyCost = 5, Order = 11, VFX = "Punch", Description = "A physical attack using the prison surroundings." },
	...
	["ORA!"] = { Requirement = "Star Platinum", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Punch", Description = "An overwhelming strike of incredible power." },
	["Star Finger"] = { Requirement = "Star Platinum", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 10, Effect = "Bleed", Duration = 2, Cooldown = 4, Order = 12, VFX = "Slash", Description = "A piercing strike that causes intense bleeding." },
	...
	["Donut Punch"] = { Requirement = "King Crimson", Type = "Stand", Mult = 2.9, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Punch", Description = "A devastating punch straight through the enemy's torso." },
	...
	["DORA DORA DORA!"] = { Requirement = "Crazy Diamond", Type = "Stand", Mult = 0.7, Hits = 3, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Punch", Description = "A rapid barrage of high-strength punches." },
	...
	["MUDA!"] = { Requirement = "Gold Experience", Type = "Stand", Mult = 2.3, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Punch", Description = "A fast and precise punch." },
	...
	["C-R-A-P"] = { Requirement = "Echoes Act 3", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "A heavy, concentrated strike." },
	...
	["Page Peel"] = { Requirement = "Heaven's Door", Type = "Stand", Mult = 2.7, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Slash", Description = "Slashes with a pen, peeling open the enemy's skin like a book." },
	...
	["Erasure Barrage"] = { Requirement = "The Hand", Type = "Stand", Mult = 0.9, Hits = 3, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Slash", Description = "Quickly erases the space in front of you wildy." },
	["Space Erasure"] = { Requirement = "The Hand", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 10, Effect = "Rupture", Duration = 3, Cooldown = 5, Order = 12, VFX = "Slash", Description = "Swipes the air, completely erasing anything in its path, causing Rupture." },
	...
	["Shattering Fist"] = { Requirement = "Steel Platinum", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Punch", Description = "Devastate those foes who doubted your power." },
	["Defense Breaker"] = { Requirement = "Steel Platinum", Type = "Stand", Mult = 1.0,  Hits = 3, StaminaCost = 0, EnergyCost = 12, Effect = "Debuff_Defense", Duration = 3, Cooldown = 4, Order = 12, VFX = "Punch", Description = "Destroy the defense of those who oppose you." },
	...
	["MUDA MUDA MUDA! (High Voltage)"] = { Requirement = "The World: High Voltage", Type = "Stand", Mult = 0.8, Hits = 3, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Punch", Description = "A ruthless barrage of punches from the alternate universe." },
	...
	["Speed Slice"] = { Requirement = "Made in Heaven", Type = "Stand", Mult = 2.8, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Slash", Description = "A high-speed strike that is nearly impossible to track." },
	...
	["Raging Demon"] = { Requirement = "King Crimson Requiem", Type = "Stand", Mult = 0.6, Hits = 5, StaminaCost = 0, EnergyCost = 12, Order = 11, VFX = "Punch", Description = "Unleash a flurry of rage and anger, obliterating the enemies that stand before you." },
	["Dimensional Slash"] = { Requirement = "King Crimson Requiem", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 16, Effect = "Rupture", Duration = 4, Cooldown = 6, Order = 12, VFX = "Slash", Description = "Cleave reality with your strike, causing severe, inescapable Rupture." },
	...
	["Overwrite Reality"] = { Requirement = "The World: Over Heaven", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 15, Order = 11, VFX = "Punch", Description = "Punches the target, completely overwriting their physical reality to deal immense damage." },
	...
	["Reality Barrage"] = { Requirement = "Star Platinum: Over Heaven", Type = "Stand", Mult = 1.0, Hits = 3, StaminaCost = 0, EnergyCost = 15, Order = 11, VFX = "Punch", Description = "An overwhelming punch that defies the laws of the universe." },
	["Reality Piercing Strike"] = { Requirement = "Star Platinum: Over Heaven", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 20, Effect = "Rupture", Duration = 4, Cooldown = 8, Order = 12, VFX = "Slash", Description = "Shatters the enemy's body, causing them to Rupture." },
	...
	["Nail Strike"] = { Requirement = "Tubular Bells", Type = "Stand", Mult = 1.9, StaminaCost = 0, EnergyCost = 5, Order = 11, VFX = "Punch", Description = "A harsh physical strike using metal tools." },
	...
	["Sound Construct"] = { Requirement = "In a Silent Way", Type = "Stand", Mult = 2.0, StaminaCost = 0, EnergyCost = 6, Order = 11, VFX = "Punch", Description = "Materializes a solid word to strike the enemy." },
	["Destructive Slash"] = { Requirement = "In a Silent Way", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 9, Effect = "Bleed", Duration = 3, Cooldown = 6, Order = 12, VFX = "Slash", Description = "Sends a razor-sharp slicing sound effect that causes Bleeding." },
	...
	["Grounded Strike"] = { Requirement = "20th Century Boy", Type = "Stand", Mult = 2.2, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Punch", Description = "A heavy strike utilizing the momentum of the ground." },
	...
	["Raindrop Blade"] = { Requirement = "Catch the Rainbow", Type = "Stand", Mult = 2.2, StaminaCost = 0, EnergyCost = 7, Order = 11, VFX = "Slash", Description = "Solidifies raindrops into sharp projectiles." },
	["Storm Slicer"] = { Requirement = "Catch the Rainbow", Type = "Stand", Mult = 2.8, StaminaCost = 0, EnergyCost = 10, Effect = "Bleed", Duration = 3, Cooldown = 5, Order = 12, VFX = "Slash", Description = "Locks raindrops mid-air to slice the target to ribbons." },
	...
	["Tear Blade"] = { Requirement = "Ticket to Ride", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 6, Effect = "Bleed", Duration = 3, Cooldown = 4, Order = 11, VFX = "Slash", Description = "Hardens tears into a sharp blade to slash the opponent, causing Bleed." },
	...
	["Iron Sand Rip"] = { Requirement = "Tomb of the Boom", Type = "Stand", Mult = 2.8, StaminaCost = 0, EnergyCost = 12, Effect = "Rupture", Duration = 4, Cooldown = 5, Order = 12, VFX = "Slash", Description = "Forces iron particles to violently rip through the enemy's skin from the inside out." },
	...
	["Dimensional Strike"] = { Requirement = "Dirty Deeds Done Dirt Cheap", Type = "Stand", Mult = 2.7, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Punch", Description = "A crushing chop backed by dimensional force." },
	...
	["Raptor Claw"] = { Requirement = "Scary Monsters", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Slash", Description = "A vicious slash from dinosaur claws." },
	...
	["Infinite Rotation"] = { Requirement = "Tusk Act 4", Type = "Stand", Mult = 1.0, Hits = 3, StaminaCost = 0, EnergyCost = 14, Order = 11, VFX = "Punch", Description = "A punch carrying the perfect golden spin." },
	...
	["Light Strike"] = { Requirement = "D4C Love Train", Type = "Stand", Mult = 2.9, StaminaCost = 0, EnergyCost = 14, Order = 11, VFX = "Slash", Description = "A devastating chop imbued with the holy light." },
	...
	["Peel"] = { Requirement = "Canine Style", Type = "Stand", Mult = 1.1, Hits = 2, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Slash", Description = "Peels off your skin like an apple to strike the enemy." },
	...
	["Sling"] = { Requirement = "Canine Style", Type = "Stand", Mult = 2.2, StaminaCost = 0, EnergyCost = 20, Cooldown = 3, Order = 13, VFX = "Punch", Description = "Slingshots yourself using your peeled limbs for a heavy strike." },

	["Above You"] = { Requirement = "Fun Fun Fun", Type = "Stand", Mult = 2.1, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A calculated strike from directly above the target." },
	...
	["Sneak Attack"] = { Requirement = "California King Bed", Type = "Stand", Mult = 1.9, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A sly, underhanded physical attack." },
	...
	["Origami Strike"] = { Requirement = "Paper Moon King", Type = "Stand", Mult = 2.0, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Slash", Description = "Slashes the enemy with an impossibly sharp folded paper." },
	...
	["Card Conceal"] = { Requirement = "Space Trucking", Type = "Stand", Mult = 2.1, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Slash", Description = "Slices the enemy with a rigid playing card." },
	...
	["Eject Object"] = { Requirement = "Space Trucking", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 20, Cooldown = 4, Order = 13, VFX = "Punch", Description = "Violently ejects a stored heavy object into the target." },

	["Cash Bash"] = { Requirement = "Milagro Man", Type = "Stand", Mult = 2.3, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A heavy strike fueled by a cursed wad of cash." },
	...
	["Crushing Debt"] = { Requirement = "Milagro Man", Type = "Stand", Mult = 2.8, StaminaCost = 0, EnergyCost = 30, Cooldown = 5, Order = 13, VFX = "Punch", Description = "Crushes the opponent under the physical weight of the curse." },

	["Jigsaw Strike"] = { Requirement = "King Nothing", Type = "Stand", Mult = 2.1, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A fast strike from a puzzle-piece fist." },
	...
	["Dismantling"] = { Requirement = "King Nothing", Type = "Stand", Mult = 1.3, Hits = 2, StaminaCost = 0, EnergyCost = 25, Cooldown = 4, Order = 13, VFX = "Punch", Description = "Breaks into puzzle pieces to surround and strike the target twice." },

	["Heel Spike"] = { Requirement = "Walking Heart", Type = "Stand", Mult = 2.3, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A brutal kick using hardened heel spikes." },
	...
	["Impale"] = { Requirement = "Walking Heart", Type = "Stand", Mult = 2.7, StaminaCost = 0, EnergyCost = 30, Effect = "Bleed", Duration = 3, Cooldown = 5, Order = 13, VFX = "Slash", Description = "Deeply impales the target's foot, causing severe Bleeding." },

	["Hair Whip"] = { Requirement = "Love Love Deluxe", Type = "Stand", Mult = 2.2, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Slash", Description = "Whips the enemy with extended strands of hair." },
	...
	["Strangle"] = { Requirement = "Love Love Deluxe", Type = "Stand", Mult = 2.8, StaminaCost = 0, EnergyCost = 25, Cooldown = 4, Order = 13, VFX = "Punch", Description = "Constricts the overgrown hair for heavy damage." },

	["Tornado Strike"] = { Requirement = "Doobie Wah!", Type = "Stand", Mult = 1.2, Hits = 2, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A rapid double-strike using miniature tornadoes." },
	...
	["Toxin Touch"] = { Requirement = "Brain Storm", Type = "Stand", Mult = 2.1, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A light touch that begins the breakdown process." },
	...
	["Melt"] = { Requirement = "Brain Storm", Type = "Stand", Mult = 1.3, Hits = 2, StaminaCost = 0, EnergyCost = 25, Cooldown = 4, Order = 13, VFX = "Punch", Description = "Spreads the infection rapidly, dealing two waves of heavy damage." },

	["Zombie Strike"] = { Requirement = "Blue Hawaii", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A relentless, unfeeling physical attack from an infected host." },
	...
	["Relentless Pursuit"] = { Requirement = "Blue Hawaii", Type = "Stand", Mult = 2.9, StaminaCost = 0, EnergyCost = 30, Cooldown = 5, Order = 13, VFX = "Punch", Description = "Commands all infected hosts to pile onto the target at once." },

	["Direct Route"] = { Requirement = "Paisley Park", Type = "Stand", Mult = 2.3, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "Finds the exact path of least resistance to strike." },
	...
	["Nut & Bolt Punch"] = { Requirement = "Nut King Call", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A solid punch that implants a nut and bolt into the enemy." },
	...
	["Screw Off"] = { Requirement = "Nut King Call", Type = "Stand", Mult = 2.9, StaminaCost = 0, EnergyCost = 30, Effect = "Bleed", Duration = 3, Cooldown = 5, Order = 13, VFX = "Slash", Description = "Violently removes the nuts and bolts, causing severe Bleeding." },

	["Heat Strike"] = { Requirement = "Speed King", Type = "Stand", Mult = 2.5, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A fast strike that slightly raises the target's temperature." },
	...
	["Gravity Pull"] = { Requirement = "I Am a Rock", Type = "Stand", Mult = 2.4, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A heavy strike utilizing the target's own gravity." },
	...
	["Spike Rain"] = { Requirement = "I Am a Rock", Type = "Stand", Mult = 0.9, Hits = 3, StaminaCost = 0, EnergyCost = 30, Cooldown = 4, Order = 13, VFX = "Slash", Description = "Pulls a swarm of sharp rocks directly into the target's center of gravity." },

	["Soft Strike"] = { Requirement = "Vitamin C", Type = "Stand", Mult = 2.2, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A seemingly harmless punch that leaves a handprint." },
	...
	["Pressure Push"] = { Requirement = "Ozon Baby", Type = "Stand", Mult = 2.5, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A blast of highly pressurized air." },
	...
	["Crush"] = { Requirement = "Ozon Baby", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 30, Cooldown = 5, Order = 13, VFX = "Punch", Description = "Instantly restores pressure to normal, crushing the target's internal organs." },

	["Bubble Strike"] = { Requirement = "Soft & Wet", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A fast punch accompanied by a floating soap bubble." },
	...
	["Soap Bubble Barrage"] = { Requirement = "Soft & Wet", Type = "Stand", Mult = 0.9, Hits = 3, StaminaCost = 0, EnergyCost = 30, Cooldown = 4, Order = 14, VFX = "Punch", Description = "A relentless barrage of physical punches and explosive bubbles." },

	["Hook Punch"] = { Requirement = "Killer Queen (Part 8)", Type = "Stand", Mult = 2.5, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A precise, methodical punch." },
	...
	["Frost Strike"] = { Requirement = "Born This Way", Type = "Stand", Mult = 2.7, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A heavy, freezing strike." },
	...
	["Motorcycle Charge"] = { Requirement = "Born This Way", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 30, Cooldown = 5, Order = 13, VFX = "Punch", Description = "Rams the target at full speed with a frozen motorcycle." },
	...
	["Vector Punch"] = { Requirement = "Awaking III Leaves", Type = "Stand", Mult = 2.6, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A punch guided by perfectly aligned vectors." },
	...
	["Vector Tornado"] = { Requirement = "Awaking III Leaves", Type = "Stand", Mult = 1.0, Hits = 3, StaminaCost = 0, EnergyCost = 35, Cooldown = 5, Order = 14, VFX = "Slash", Description = "Combines multiple vectors into a destructive, multi-hit whirlwind." },
	...
	["Go Beyond Barrage"] = { Requirement = "Soft & Wet: Go Beyond", Type = "Stand", Mult = 1.0, Hits = 3, StaminaCost = 0, EnergyCost = 30, Cooldown = 5, Order = 12, VFX = "Punch", Description = "A devastating barrage of logic-defying explosive bubbles." },
	...
	["Cane Strike"] = { Requirement = "Wonder of U", Type = "Stand", Mult = 3.0, StaminaCost = 0, EnergyCost = 15, Cooldown = 0, Order = 11, VFX = "Punch", Description = "A simple, yet impossibly painful strike with a cane." },
	...
	["Rain of Debris"] = { Requirement = "Wonder of U", Type = "Stand", Mult = 0.6, Hits = 5, StaminaCost = 0, EnergyCost = 35, Effect = "Calamity", Duration = 3, Cooldown = 6, Order = 14, VFX = "Punch", Description = "A calamity forces surrounding objects to violently crash into the target." },
	...
	["Waaah!"] = { Requirement = "Chiikawa", Type = "Stand", Mult = 2.5, StaminaCost = 0, EnergyCost = 8, Order = 11, VFX = "Punch", Description = "Tears up and wildly flails around." },
	...
	["Weed Whacker"] = { Requirement = "Chiikawa", Type = "Stand", Mult = 0.7, Hits = 5, StaminaCost = 0, EnergyCost = 15, Effect = "Bleed", Duration = 2, Cooldown = 4, Order = 14, VFX = "Slash", Description = "Wildly swings a weed whacker, dealing multi-hit damage." },
