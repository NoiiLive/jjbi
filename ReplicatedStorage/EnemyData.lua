...
EnemyData.Allies = {
	["Will A. Zeppeli"] = { Name = "Will A. Zeppeli", Icon = "", Health = 80, Strength = 12, Defense = 5, Speed = 8, Willpower = 10, StandStats = emptyStands, Skills = {"Sunlight Yellow Overdrive", "Deep Breathing", "Basic Attack"} },
	["Caesar Zeppeli"] = { Name = "Caesar Zeppeli", Icon = "", Health = 150, Strength = 20, Defense = 10, Speed = 15, Willpower = 15, StandStats = emptyStands, Skills = {"Heavy Strike", "Deep Breathing", "Basic Attack"} },
	["Polnareff"] = { Name = "Jean Pierre Polnareff", Icon = "", Health = 250, Strength = 35, Defense = 15, Speed = 35, Willpower = 20, StandStats = {Power="C", Speed="A", Range="C", Durability="B", Precision="B", Potential="C"}, Skills = {"Silver Rapier", "Armor Off", "Stand Barrage"} },
	["Okuyasu"] = { Name = "Okuyasu Nijimura", Icon = "rbxassetid://95630365107580", Health = 400, Strength = 50, Defense = 30, Speed = 25, Willpower = 25, StandStats = {Power="B", Speed="B", Range="D", Durability="C", Precision="C", Potential="C"}, Skills = {"Space Erasure", "Erasure Barrage", "Erasure Pull", "Basic Attack"} },
	["Gyro"] = { Name = "Gyro Zeppeli", Icon = "", Health = 1000, Strength = 150, Defense = 80, Speed = 65, Willpower = 125, Skills = {"Steel Ball Throw", "Wrecking Ball", "Ratio Visualization", "Basic Attack"} },
	["Yasuho"] = { Name = "Yasuho Hirose", Icon = "", Health = 8000, Strength = 200, Defense = 150, Speed = 200, Willpower = 150, StandStats = {Power="E", Speed="E", Range="A", Durability="A", Precision="D", Potential="C"}, Skills = {"Direct Route", "Navigation", "Electronic Hack", "Basic Attack"} }
}
